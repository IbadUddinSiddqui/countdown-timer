...
function Countdown() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      timerEndSoundRef.current = new Audio("/countdown-sound.mp3");
    }
  }, []);
      ...
      <div className="bg-white/30 backdrop-blur-lg rounded-xl shadow-2xl p-6 w-full max-w-xs sm:max-w-sm text-center">
        ...
        <div className="flex flex-col gap-3 mb-4 w-full">
          <Input
            ...
            className="w-full text-center py-2 px-4 rounded-md border text-black dark:text-white border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <Input
            ...
            className="w-full text-center py-2 px-4 rounded-md border border-gray-300  text-black dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
